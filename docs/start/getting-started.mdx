...
<Columns cols={3}>
  <Card title="Get Started" href="/docs/start/installation" icon="download">
    Install OpenPawz and bring up the app in minutes.
  </Card>
  <Card title="Create an Agent" href="/docs/start/first-agent" icon="robot">
    Guided setup for personality, provider, and tools.
  </Card>
  <Card title="Connect a Provider" href="/docs/start/first-provider" icon="server">
...
Need the full install guide? See [Installation](/docs/start/installation).
...
<Columns cols={3}>
  <Card title="Installation" href="/docs/start/installation" icon="download">
    Prerequisites and build instructions for macOS, Linux, and Windows.
  </Card>
  <Card title="First Agent" href="/docs/start/first-agent" icon="robot">
    Step-by-step guide to creating and configuring an agent.
  </Card>
  <Card title="First Provider" href="/docs/start/first-provider" icon="server">
