...
- docs/reference/architecture-full.md — full system design
- docs/reference/security-full.md — 7-layer defense-in-depth documentation
- docs/community/contributing.md — contributor guide
