...
<Columns cols={3}>
  <Card title="Ollama" href="/docs/providers/ollama" icon="server">
    Local inference — no API key needed
  </Card>
  <Card title="OpenAI" href="/docs/providers/openai" icon="bolt">
    GPT-5.1, GPT-4.1, o3, o4-mini
  </Card>
  <Card title="Anthropic" href="/docs/providers/anthropic" icon="brain">
    Claude 4 Opus, Sonnet, Haiku
  </Card>
  <Card title="Google" href="/docs/providers/google" icon="google">
    Gemini 2.5 Pro, Flash
  </Card>
  <Card title="OpenRouter" href="/docs/providers/openrouter" icon="route">
    200+ models via unified API
  </Card>
  <Card title="DeepSeek" href="/docs/providers/deepseek" icon="magnifying-glass">
    DeepSeek V3, R1, Coder
  </Card>
  <Card title="Grok" href="/docs/providers/grok" icon="xmark">
    xAI's Grok models
  </Card>
  <Card title="Mistral" href="/docs/providers/mistral" icon="wind">
    Mistral Large, Codestral
  </Card>
  <Card title="Moonshot" href="/docs/providers/moonshot" icon="moon">
    Kimi and Moonshot models
  </Card>
  <Card title="Custom" href="/docs/providers/custom" icon="plug">
